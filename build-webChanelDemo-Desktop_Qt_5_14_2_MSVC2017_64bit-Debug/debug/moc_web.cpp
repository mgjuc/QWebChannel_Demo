...
QT_MOC_LITERAL(1, 4, 18), // "SigSendMessageToJS"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12), // "strParameter"
QT_MOC_LITERAL(4, 37, 22), // "OnReceiveMessageFromJS"
QT_MOC_LITERAL(5, 60, 3), // "usr"
QT_MOC_LITERAL(6, 64, 6) // "passwd"

    },
    "Web\0SigSendMessageToJS\0\0strParameter\0"
    "OnReceiveMessageFromJS\0usr\0passwd"
};
...
void Web::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Web *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SigSendMessageToJS((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->OnReceiveMessageFromJS((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Web::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Web::SigSendMessageToJS)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Web::SigSendMessageToJS(QString _t1)
{
